...
const char* info = "\n"
        ...
        "\n"
        "   - anvendt tid pr par\n"
        "   - gjennomsnittstid for alle parene\n"
        "   - avvik mellom anvendt tid og gjennomsnittstid, pr par\n"
        ...
        "opprette i de fleste regne-ark-programmene, f.eks Excel.\n"
        "\n"
        "Eksempel på input: (vise hvilke kolonner som må være med) \n"
        "\n"
